    ...
    <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <!-- Quản lý người dùng -->
                <li class="nav-item">
                    <a class="nav-link <?= in_array($current_page, ['users.php', 'user-add.php', 'user-edit.php']) ? 'active' : '' ?>" 
                       href="#userSubmenu" data-bs-toggle="collapse" aria-expanded="false">
                        <i class="fas fa-users"></i>
                        <span>Quản lý người dùng</span>
                        <i class="fas fa-chevron-down ms-auto"></i>
                    </a>
                    <ul class="collapse nav flex-column ms-3 <?= in_array($current_page, ['users.php', 'user-add.php', 'user-edit.php']) ? 'show' : '' ?>" 
                        id="userSubmenu">
                        <li class="nav-item">
                            <a class="nav-link <?= $current_page == 'users.php' && (!isset($_GET['role']) || $_GET['role'] == 'all') ? 'active' : '' ?>" 
                               href="users.php">
                ...
                <!-- Quản lý lịch hẹn -->
                <li class="nav-item">
                    <a class="nav-link <?= in_array($current_page, ['appointments.php', 'appointment-add.php', 'appointment-edit.php']) ? 'active' : '' ?>" 
                ...
                <!-- Quản lý nội dung -->
                <li class="nav-item">
                    <a class="nav-link <?= in_array($current_page, ['content.php', 'news.php', 'pages.php']) ? 'active' : '' ?>" 
                       href="#contentSubmenu" data-bs-toggle="collapse" aria-expanded="false">
                        <i class="fas fa-edit"></i>
                        <span>Quản lý nội dung</span>
                        <i class="fas fa-chevron-down ms-auto"></i>
                    </a>
                    <ul class="collapse nav flex-column ms-3 <?= in_array($current_page, ['content.php', 'news.php', 'pages.php']) ? 'show' : '' ?>" 
                        id="contentSubmenu">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $current_page == 'pages.php' ? 'active' : '' ?>" 
                               href="pages.php">
        ...
        <div class="sidebar-footer">
            ...
            <div class="text-center mt-3">
                <small class="text-muted">© 2024 QickMed</small>
            </div>
        </div>
    </div>
</aside> 