...
<body>
    <div class="container">
        <div class="header">
            <h1>📋 Cart Logs Viewer</h1>
            <p>Real-time monitoring của cart actions</p>
        </div>
        ...
        <div class="log-controls">
            ...
            <a href="../shop.php" style="color: #007acc; text-decoration: none; margin-left: 20px;">← Back to Shop</a>
        </div>
        
        <div class="log-viewer" id="logViewer">
            <div style="color: #858585; text-align: center; padding: 50px;">
                📝 Select a log file to view<br><br>
                <strong>Instructions:</strong><br>
                1. Chọn log file từ dropdown<br>
                2. Use filter để lọc log theo type<br>
                3. Enable auto refresh để theo dõi real-time<br>
                4. Test add to cart từ shop để xem logs
            </div>
        </div>
    </div>
